...
from .error_handling import (
    ...
    handle_stack_underflow_with_count,
)
...
class Stack:
    ...
    def __init__(self, size):
        ...
        ]  # create buffer for the specified stack size and fill it with 0
        self.stack_pointer = (
            -1
        )  # start sp at -1 so that we can properly start with 0, as it always should be
        self.size = size
